                ...
                for (int j = 1; j < trs.getLength(); j++) {
                    try {
                        ...
                        if ("nimi".equals(namecell.getClassName())) {
                            ...
                            final String innerText = namecell.getFirstChildElement().getInnerText();
                            person.setFirstName(innerText.substring(0, innerText.indexOf(" ")));
                            person.setLastName(innerText.substring(innerText.indexOf(" ")+1));
                            ...
                            if (rcell.matches("[0-9].*")) {
                                ...
                                for (int k = 2; k < tds.getLength() - 2; k++) {
                                    ...
                                    if (timestr.equals("-")) {
                                        ...
                                        timestr = timestr.substring(0, timestr.
                                                indexOf("(") - 1);
